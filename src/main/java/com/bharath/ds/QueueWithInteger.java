...
//Implementation of Queue with an fixed array wrt to integers
public class QueueWithInteger {
	...
	public QueueWithInteger(int capacity) {
		...
		this.array = new int[capacity];// intitializing an array with provided capacity
	...
	public boolean isFull(QueueWithInteger queue) {
